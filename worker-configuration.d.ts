/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: b79a86f6e039c8af671a80312cf3472c)
// Runtime types generated with workerd@1.20250803.0 2024-04-03 
declare namespace Cloudflare {
	interface Env {
		DISCORD_JOINS_WEBHOOK_URL: string;
		API_KEY: string;
